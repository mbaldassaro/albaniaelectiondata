...
infoDiffC15.update = function(props) {
  ...
  + '<h4>Valid Votes: ' + props.totalCouncil + '</h4>'
  + '<h3>' + props.partyASE + '</h3>'
  + '<h4>Votes Received: ' + props.aseCouncil + '</h4>'
  + '<h4>Percentage: ' + props.pctASE + '%</h4>'
  + '<h4>Seats Won: ' + props.aseSeats + '</h4>'
  + '<h3>' + props.partyAPPD + '</h3>'
  + '<h4>Votes Received: ' + props.appdCouncil + '</h4>'
  + '<h4>Percentage: ' + props.pctAPPD + '%</h4>'
  + '<h4>Seats Won: ' + props.appdSeats + '</h4><br>'
  + '<h4>Difference (+/-): ' + props.percent + '%</h4><br>'
  + '<h4>Other Votes: ' + props.otherCouncil + '</h4>'
  //+ '<h4>Other Percentage: ' + props.otherPCT + '%</h4>'
  + '<h4>Other Seats: ' + props.otherSeats + '</h4>'
  + '<br><br><br><br>'
  + '' : '')
};
